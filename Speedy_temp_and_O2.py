...
spi.mode = 0b01
spi.max_speed_hz = 1400000000/128  #this can be any of the following - 
...
sleep(.01)
ads1262_Reg_Write(MODE0, 0x40)		#0x40 for pulse conversion 0x00 for continuous
sleep(.01)
ads1262_Reg_Write(MODE1, 0x03<<5)	#Ch 1 enabled, gain 6, connected to electrode in
sleep(.01)
ads1262_Reg_Write(MODE2,  0x49) #sets PGA and datarate
sleep(.01)
